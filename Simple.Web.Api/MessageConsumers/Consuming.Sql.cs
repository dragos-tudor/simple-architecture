...
{
  internal static Task ConsumeSqlMessages (Channel<Message> messageQueue, Subscriber<Message, Failure>[] subscribers, AgendaContextFactory agendaContextFactory, ILogger logger) =>
    ConsumeMessages(
      messageQueue,
