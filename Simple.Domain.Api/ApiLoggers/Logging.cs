...
partial class ApiFuncs
{
  ...
  [LoggerMessage(3, LogLevel.Information, "Notification: Added to agenda notification sent to {AddressTo}. [{TraceId}]", EventName = "LogAddedToAgenda")]
  public static partial void LogAddedToAgendaNotification (ILogger logger, string addressTo, string? traceId);
}