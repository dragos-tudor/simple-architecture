...
partial class MediatorTests
{
  ...
  {
    var sub = CreateSubscriber<string, string, string>("sub", (_, _) => Task.FromResult(default(string)));
  ...
  {
    var sub1 = CreateSubscriber<string, string, string>("sub1", (_, _) => Task.FromResult(default(string)));
    var sub2 = CreateSubscriber<string, string, string>("sub2", (_, _) => Task.FromResult(default(string)));
  ...
  {
    var sub1 = CreateSubscriber<string, string, string>("sub1", (_, _) => Task.FromResult(default(string)));
    var sub2 = CreateSubscriber<string, int, string>("sub2", (_, _) => Task.FromResult(default(string)));
    var subs2 = RegisterSubscriber(sub2, [sub1]);
  ...
  {
    var sub1 = CreateSubscriber<string, string, string>("sub1", (_, _) => Task.FromResult(default(string)));
    var sub2 = CreateSubscriber<string, string, string>("sub1", (_, _) => Task.FromResult(default(string)));
  ...
  {
    var actual = RegisterSubscriber(new Subscriber<string, string>(default!, "some type", default!), []);
  ...
  {
    var actual = RegisterSubscriber(new Subscriber<string, string>("sub1", default!, default!), []);
