...
{
  [LoggerMessage(1, LogLevel.Information, "Consumer: handling message {MessageType}. [{TraceId}]", EventName = "LogHandlingMessage")]
  ...
  [LoggerMessage(11, LogLevel.Error, "Consuner: consuming message {MessageType} error {Error}. [{TraceId}]\n{StackTrace}", EventName = "LogConsumedMessageError")]
  ...
  [LoggerMessage(12, LogLevel.Error, "Consumer: handled message {MessageType} error {Error}. [{TraceId}]", EventName = "LogHandledMessageError")]
