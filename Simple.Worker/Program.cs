...
partial class WorkerFuncs
{
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    var sqlMessageJob = messageJob with { JobAction = () => ProcessMessageSqlAsync(dbContextFactory, 10, messageJob.MessagesJobOptions, timeProvider, logger, cancellationToken) };
    ...
    var mongoMessageJob = messageJob with { JobAction = () => ProcessMessageMongoAsync(mongoDatabase, 10, messageJob.MessagesJobOptions, timeProvider, logger, cancellationToken) };
